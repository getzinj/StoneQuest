...
Procedure Handle_Monster_Group_Spell_1 (Attacker: Attacker_Type;  Var Member: Party_Type;  Current_Party_Size: Integer);
...
Procedure Handle_Monster_Group_Spell_2 (Attacker: Attacker_Type;  Var Member: Party_Type;  Current_Party_Size: Integer);
...
Procedure Handle_Monster_Protection_Spell (Attacker: Attacker_Type; Var Group: Monster_Group);
...
Procedure Handle_Monster_Non_Lethal (Attacker: Attacker_Type; Var Member: Party_Type; Current_Party_Size: Integer);
...
Procedure Implement_Spell (Attacker: Attacker_Type;  Spell_Chosen: Spell_Name;  Var Member: Party_Type;
...
[Global]Procedure Monster_Spell (Attacker: Attacker_Type; Var Group: Encounter_Group; Var Member: Party_Type;
